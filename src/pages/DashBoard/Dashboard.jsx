                ...
                <Grid container spacing={4}>
                  <Grid item xs={6}>
                    <Button
                      ...
                      sx={{ marginTop: "25px" }}
                      variant="contained"
                      onClick={handlePregnancyHistory}
                    >
                  ...
                  <Grid item xs={6}> 
                    <Button
                      ...
                      sx={{ marginTop: "25px" }}
                      variant="contained"
                      onClick={handleDoctorRegi}
                    >
                      View Doctor Registrations{" "}
                    </Button>
                  </Grid>
                </Grid>
              </Paper>
