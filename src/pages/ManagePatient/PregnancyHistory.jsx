...
export default function DataTable() {
  const columns = [
    ...
    { id: "5", label: "MOBILE NUMBER", minWidth: 100 },
    {
      id: "6",
      label: "EDD",
      minWidth: 100,
      format: (value) => user.edd.format("YYYY-MM-DD"),
    },
    { id: "7", label: "HOW MANY CHILDREN", minWidth: 100 },
    { id: "8", label: "STATE", minWidth: 100 },
    { id: "9", label: "VIEW", minWidth: 100 },
  ];
                ...
                .map((user, index) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell align="left" direction="row">
                      ...
                      {/* <VisibilityIcon  variant="outlined" className="space"> View </VisibilityIcon> */}
                    </TableCell>
                  </TableRow>
                ))}
            </TableBody>
